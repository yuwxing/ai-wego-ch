...
const GRADE_UNITS: Record<string, string[]> = {
  ...
  '7b': ['Unit 1 Animal Friends', 'Unit 2 No Rules, No Order', 'Unit 3 Keep Fit', 'Unit 4 Eat Well', 'Unit 5 Here and Now', 'Unit 6 Rain or Shine', 'Unit 7 A Day to Remember', 'Unit 8 Once Upon a Time'],
