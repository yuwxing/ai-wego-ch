...
const G7: VerbEntry[] = [
  ...
  { base: 'do', past: 'did', pp: 'done', meaning: '做', level: 1 },
  ...
  { base: 'hang', past: 'hung', pp: 'hung', meaning: '悬挂', level: 2 },
  { base: 'have', past: 'had', pp: 'had', meaning: '有', level: 1 },
  ...
  { base: 'lie', past: 'lay', pp: 'lain', meaning: '躺', level: 3 },
  ...
  { base: 'speak', past: 'spoke', pp: 'spoken', meaning: '讲', level: 1 },
...
const G8D: VerbEntry[] = [
  ...
  { base: 'find', past: 'found', pp: 'found', meaning: '找到', level: 1 },
  { base: 'get', past: 'got', pp: 'got/gotten', meaning: '得到', level: 1 },
  { base: 'hang', past: 'hung', pp: 'hung', meaning: '悬挂；吊', level: 2 },
  { base: 'have', past: 'had', pp: 'had', meaning: '有', level: 1 },
  { base: 'hear', past: 'heard', pp: 'heard', meaning: '听见', level: 1 },
  ...
  { base: 'hide', past: 'hid', pp: 'hidden', meaning: '躲藏', level: 2 },
  { base: 'know', past: 'knew', pp: 'known', meaning: '知道', level: 1 },
  { base: 'lie', past: 'lay', pp: 'lain', meaning: '躺；位于', level: 3 },
  { base: 'ride', past: 'rode', pp: 'ridden', meaning: '骑', level: 2 },
